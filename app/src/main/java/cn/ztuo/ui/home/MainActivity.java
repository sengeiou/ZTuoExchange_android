...
import cn.ztuo.R;
import cn.ztuo.ui.home.presenter.FivePresenter;
import cn.ztuo.ui.home.presenter.FourPresenter;
import cn.ztuo.ui.home.presenter.MainPresenter;
import cn.ztuo.ui.home.presenter.OnePresenter;
import cn.ztuo.ui.home.presenter.TwoPresenter;
import cn.ztuo.ui.kline.KlineActivity;
import cn.ztuo.adapter.DrawerListener;
...
import cn.ztuo.base.BaseTransFragmentActivity;
import cn.ztuo.entity.ChatTable;
import cn.ztuo.entity.ChatTipEvent;
...
import cn.ztuo.serivce.MyService;
import cn.ztuo.serivce.MyTextService;
...
import cn.ztuo.utils.WonderfulDatabaseUtils;
import cn.ztuo.utils.WonderfulLogUtils;
import cn.ztuo.utils.WonderfulPermissionUtils;
...
public class MainActivity extends BaseTransFragmentActivity implements MainContract.View, MarketBaseFragment.MarketOperateCallback {
    ...
    private void recoverMenuFragment() {
        ...
        favoriteFragment = (FavoriteFragment) getSupportFragmentManager().findFragmentByTag(BaseFragment.makeFragmentName(vpMenu.getId(), 3));
...
//        startService(intentTcp);
    ...
    private void setCurrency(List<Currency> currencies) {
        ...
        if (threeFragment != null) threeFragment.setViewContent(currencyListAll);
    }
