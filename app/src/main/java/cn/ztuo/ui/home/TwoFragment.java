...
import cn.ztuo.base.BaseNestingTransFragment;
...
public class TwoFragment extends BaseNestingTransFragment implements MainContract.TwoView {
    ...
    protected void recoveryFragments() {
        ...
        favoriteFragment = (FavoriteFragment) getChildFragmentManager().findFragmentByTag(makeFragmentName(vpPager.getId(), 3));
