...
import cn.ztuo.ui.home.presenter.ThreeTextImpl;
import cn.ztuo.ui.kline.KlineActivity;
import cn.ztuo.ui.login.LoginActivity;
import cn.ztuo.adapter.SellAdapter;
import cn.ztuo.adapter.TrustCurrentAdapter;
import cn.ztuo.adapter.TrustHistoryAdapter;
import cn.ztuo.app.MyApplication;
import cn.ztuo.base.BaseTransFragment;
import cn.ztuo.ui.dialog.BBConfirmDialogFragment;
...
import cn.ztuo.entity.Money;
import cn.ztuo.entity.TextItems;
...
import cn.ztuo.utils.IMyTextChange;
...
public class ThreeTextFragment extends BaseTransFragment implements RadioGroup.OnCheckedChangeListener, IThreeTextContract.View, View.OnClickListener {
...
//            Log.i("miao","币种："+ getmActivity().getId());
    ...
    public void showPageFragment(String symbol, int pageNo) {
        if (this.currencies == null) return;
        // this.page = pageNo;
