...
public class MyTextService extends Service {
    ...
    private static final String ip = "18.136.195.191";//行情 真实
...
//        WonderfulLogUtils.logi(TAG, "222222" + "接受的信息" + message.getCmd()+"message:"+message.getCode());
...
//                WonderfulLogUtils.logi(TAG, "myTextService接受的信息"+cmd +" --"+ str);
            }
        }catch (Exception e){
